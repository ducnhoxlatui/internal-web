                ...
                <div className="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
                    <div className="max-w-xl mx-auto">
                        <div className="text-center ">
                            <div className="relative flex flex-col items-center">
                                ...
                                <h1 className="text-5xl font-bold leading-tight text-white"> Looker Team <span
                    ...
                    <div className="relative flex justify-between">
                            <div className="hidden w-24 py-3 md:block ">
                                <h2 className="text-base font-medium text-gray-700 text-white">2022 Jun</h2>
                            </div>
                            <div className="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                                <h2 className="text-base font-medium text-gray-700 dark:text-gray-400">2022 Jun</h2>
                            </div>
                            ...
                            <div className="relative flex-1 mb-16 bg-white rounded shadow md:mb-8 dark:bg-gray-900">
                                ...
                                <div className="relative z-20 p-6">
                                    ...
                                    Welcome Thuong Huynh, Thinh Do, Hai To. Their collaboration marked the beginning of Looker's innovative journey.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="relative flex justify-between">
                            <div className="hidden w-24 py-3 md:block ">
                                <h2 className="text-base font-medium text-gray-700 text-white">2022 Oct</h2>
                            </div>
                            <div className="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                                <h2 className="text-base font-medium text-gray-700 dark:text-gray-400">2022 Oct</h2>
                            </div>
                            <div className="flex flex-col items-center w-10 mr-4 md:w-24">
                                <div>
                                    <div
                        ...
                        <div className="relative flex justify-between">
                            <div className="hidden w-24 py-3 md:block ">
                                <h2 className="text-base font-medium text-gray-700 text-white">2023 Feb</h2>
                            </div>
                            <div className="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                                <h2 className="text-base font-medium text-gray-700 dark:text-gray-400">2023 Feb</h2>
                            </div>
                            <div className="flex flex-col items-center w-10 mr-4 md:w-24">
                                <div>
                                    <div
                        ...
                        <div className="relative flex justify-between">
                            <div className="hidden w-24 py-3 md:block ">
                                <h2 className="text-base font-medium text-gray-700 text-white">2023 May</h2>
                            </div>
                            <div className="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                                <h2 className="text-base font-medium text-gray-700 dark:text-gray-400">2023 May</h2>
                            </div>
                            <div className="flex flex-col items-center w-10 mr-4 md:w-24">
                                <div>
                                    <div
                        ...
                        <div className="relative flex justify-between">
                            <div className="hidden w-24 py-3 md:block ">
                                <h2 className="text-base font-medium text-gray-700 text-white">2023 Aug</h2>
                            </div>
                            <div className="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                                <h2 className="text-base font-medium text-gray-700 dark:text-gray-400">2023 Aug</h2>
                            </div>
                            <div className="flex flex-col items-center w-10 mr-4 md:w-24">
                                <div>
                                    <div
                    ...
                    <div className="relative flex justify-between">
                            <div className="hidden w-24 py-3 md:block ">
                                <h2 className="text-base font-medium text-white">2024 Jan </h2>
                            </div>
                            <div className="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                                <h2 className="text-base font-medium text-gray-700 dark:text-gray-400">2024 Jan</h2>
                            </div>
                            <div className="flex flex-col items-center w-10 mr-4 md:w-24">
                                <div>
                                    <div
                        ...
                        <div className="relative flex justify-between">
                            <div className="hidden w-24 py-3 md:block ">
                                <h2 className="text-base font-medium text-white">... Loading</h2>
                            </div>
                            <div className="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                                <h2 className="text-base font-medium text-gray-700 dark:text-gray-400">... Loading</h2>
                            </div>
                            <div className="flex flex-col items-center w-10 mr-4 md:w-24">
                                <div>
                                    <div
                            ...
                            <div className="relative flex-1 mb-16 bg-white rounded shadow md:mb-8 dark:bg-gray-900">
                                ...
                                <div className="relative z-20 p-6">
                                    <p className="mb-2 text-xl font-bold text-gray-600 dark:text-gray-400">PI...</p>
                                    <p className="text-gray-700 dark:text-gray-500">
